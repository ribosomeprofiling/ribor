...
However, there is also functionality in the case that the original region lengths and coordinates without the UTR5 and/or UTR3 junctions are more useful.
The functions `get_original_region_lengths` and `get_original_region_coordinates` follow similar functionality to `get_internal_region_lengths` and `get_internal_region_coordinates`, respectively, but instead exclude any UTR5 and/or UTR3 junction information. 
